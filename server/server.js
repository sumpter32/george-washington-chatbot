...
app.post('/', async (req, res) => {
  try {
    ...
    const response = await openai.createCompletion({
      ...
      prompt: `have a persona that embodies the compassionate and wise teachings of both Jesus and Buddha. The persona should be able to provide guidance and inspiration to users seeking to live a more compassionate and meaningful life. ${prompt}`,
